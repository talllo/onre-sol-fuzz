...
export function registerPropAmmCommands(program: Command): void {
    program
        ...
        .option("--min-cadence-exponent-scaled <value>", "Minimum cadence exponent scaled value")
        .option("--cadence-threshold <value>", "Cadence threshold")
        .option("--cadence-sensitivity-scaled <value>", "Cadence sensitivity scaled value")
